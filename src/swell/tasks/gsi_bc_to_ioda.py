...
class GsiBcToIoda(taskBase):
    ...
    def execute(self) -> None:
        ...
        default_predictors.append('sensorZenithAngle')
        default_predictors.append('cloudWaterContent')
        default_predictors.append('lapseRate_order_2')
        default_predictors.append('lapseRate')
        default_predictors.append('cosineOfLatitudeTimesOrbitNode')
        default_predictors.append('sineOfLatitude')
        default_predictors.append('emissivityJacobian')
        default_predictors.append('sensorScanAngle_order_4')
        default_predictors.append('sensorScanAngle_order_3')
        default_predictors.append('sensorScanAngle_order_2')
        default_predictors.append('sensorScanAngle')

        gmi_gpm_predictors = []
        gmi_gpm_predictors.append('constant')
        gmi_gpm_predictors.append('sensorZenithAngle')
        gmi_gpm_predictors.append('cosineOfLatitudeTimesOrbitNode')
        gmi_gpm_predictors.append('lapseRate_order_2')
        gmi_gpm_predictors.append('lapseRate')
        gmi_gpm_predictors.append('cloudWaterContent_order_2')
        gmi_gpm_predictors.append('cloudWaterContent')
        gmi_gpm_predictors.append('emissivityJacobian')
        gmi_gpm_predictors.append('sensorScanAngle_order_4')
        gmi_gpm_predictors.append('sensorScanAngle_order_3')
        gmi_gpm_predictors.append('sensorScanAngle_order_2')
        gmi_gpm_predictors.append('sensorScanAngle')
